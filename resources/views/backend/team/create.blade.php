                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" type="text"
                                    id="title" name="name" placeholder="Name here.." value="{{ old('name') }}">
                                @error('name')
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="social[facebook]"
                                    placeholder="wwww.facebook.com/your-profile" value="{{ old('social.facebook') }}">
                            </div>
                            <div class="form-group">
                                <label for="inputStatus" class="mb-0">Instagram
                                </label>
                                <input class="form-control" type="text" name="social[instagram]"
                                    placeholder="wwww.instagram.com/your-profile" value="{{ old('social.instagram') }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="social[linkedin]"
                                    placeholder="wwww.linkedin.com/your-profile" value="{{ old('social.linkedin') }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="social[x]"
                                    placeholder="wwww.x.com/your-profile" value="{{ old('social.x') }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="social[youtube]"
                                    placeholder="wwww.youtube.com/your-profile" value="{{ old('social.youtube') }}">
                            </div>
                    ...
                    <div class="card card-light">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea style="height: 600px;" id="summernote" name="bio" value="{{ old('bio') }}"> {{ old('bio') }}</textarea>
                                        @error('bio')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
